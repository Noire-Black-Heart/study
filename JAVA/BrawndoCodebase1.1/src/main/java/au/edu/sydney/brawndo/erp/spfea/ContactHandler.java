...
public class ContactHandler {
    /**
     * Optimize customer contact with strategy pattern
     * In terms of handling customer contact information, each new contact method requires a new case branch in the code.
     * This is not easy to maintain and bloated.
     * Multiple conditional statements are not easy to maintain, and using strategy pattern avoids the use of multiple conditional statements
     * @param token
     * @param customer
     * @param priority
     * @param data
    ...
    public static boolean sendInvoice(AuthToken token, Customer customer, List<ContactMethod> priority, String data) {
        ContactContext cc = new ContactContext();
