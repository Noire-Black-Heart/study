...
public class LockFreeLinkedListIntSet
  ...
  public void clear() {
   ...
   class Node {
    ...
    private Node next;
    private AtomicMarkableReference<Node> aMNode;

    Node(int value, Node next) {
      this.value = value;
      this.next = next;
      aMNode = new AtomicMarkableReference<Node>(this, false);
    }
