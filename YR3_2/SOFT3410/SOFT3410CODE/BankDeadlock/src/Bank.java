...
public class Bank {
    ...
    public static void main(String[] args) {
        ...
        subtracting.start();
        */
        Thread transferring12 = new Thread(new TransferMoney(account1, account2));
        Thread transferring21 = new Thread(new TransferMoney(account2, account1));
        transferring12.start();
        transferring21.start();
    }
