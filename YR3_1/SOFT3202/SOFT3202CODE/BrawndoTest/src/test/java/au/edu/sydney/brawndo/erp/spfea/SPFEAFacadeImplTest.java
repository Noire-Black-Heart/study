...
public class SPFEAFacadeImplTest {
	...
	public void testAddTaskNull() {
		...
		myFacade.addNewTask(time, "desc1", "loc1");
		
		
	}

	@Test
	public void testAddTaskDate() {
		//null
		myFacade.setToDoProvider(myList);
		exception.expect(IllegalArgumentException.class);
		myFacade.addNewTask(null, "desc1", "loc1");
