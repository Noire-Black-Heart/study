...
//		for(Task t : myList.findAll(param, time7, time, true, false)) {
//			System.out.println(t.getID());
//		}
//		assertEquals(myList.findAll(param, time7, time, true, false).size(), 4);
		assertEquals(myList.findAll(null, time7, time, true, false).size(), 0);
