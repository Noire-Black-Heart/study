...
public interface SPFEAFacade {
     ...
     * @param phone may be null, may not be empty, may only contain numeric characters and â€?+()â€? if not null
     ...
     * @param fName may not be null or empty
     * @param lName may not be null or empty
     * @return If a customer with an exactly matching fName and lName exists in this instance, the id of that customer â€? otherwise null
     * @throws IllegalArgumentException if any of the preconditions are violated
     */
     ...
     * @return The phone field associated with this customer id â€? may be null, may not be empty, will contain only numeric characters and â€?+()â€? if not null
     ...
     * <b>Postconditions:</b><br>
     * The matching customerâ€™s phone field will be updated to match the phone parameter<br>
     *
     * @param id The target customer id
     * @param phone may be null, may not be empty, may only contain numeric characters and â€?+()â€? if not null
     ...
     *
     * @param id The target customer id
     * @return The email associated with this customer id â€? may be null, may not be empty, will contain at least one @ character if not null
     * @throws IllegalArgumentException If no matching customer exists
     */
     ...
     * <b>Postconditions:</b><br>
     * The matching customerâ€™s email field will be updated to match the email parameter<br>
     *
     * @param id The target customer id
