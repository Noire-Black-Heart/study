...
public interface ToDoList {
     ...
     * @return â€?	A reference to the created (not completed) Task matching the given parameters
     ...
     * @return True if a task with a matching id was present in the list â€? otherwise false
     */
     ...
     *
     * @param id The target task id
     * @return If a task with a matching id exists in the list, the matching task â€? otherwise null
     */
    Task findOne(int id);
