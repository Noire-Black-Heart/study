...
public class PersonalSub extends PersonalNoSub implements SubscriptionOrder {

    private int numShipments;

    public PersonalSub(int id, LocalDateTime date, Discount discount, int customerID, int numShipments) {
        super(id, date, discount, customerID);
    ...
    public Order copy() {
        ...
        Order copy = new PersonalSub(getOrderID(), getOrderDate(), discount, getCustomer(), numShipments);
