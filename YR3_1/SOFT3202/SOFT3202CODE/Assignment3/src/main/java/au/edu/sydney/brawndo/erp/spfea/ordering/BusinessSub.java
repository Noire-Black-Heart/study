...
public class BusinessSub extends BusinessNoSub implements SubscriptionOrder {
    private int numShipments;

    public BusinessSub(int id, int customerID, LocalDateTime date, Discount discount, int numShipments) {
    ...
    public Order copy() {
        ...
        Order copy = new BusinessSub(getOrderID(), getCustomer(), getOrderDate(), discount, numShipments);
